		...
		$( '.hs_CountdownHolder' ).each(function() {
			...
			var output = function() {
                ...
                if (countdownfinished){
                    document.getElementById("hs_player").style.display = "block";
                    document.getElementById("hs_counter").style.display = "none";
                    document.getElementById("hs_beforetext").style.display = "none";
                    document.getElementById("hs_aftertext").style.display = "block";
                } else {
                    document.getElementById("hs_player").style.display = "none";
                    document.getElementById("hs_counter").style.display = "inline-block";
                    document.getElementById("hs_beforetext").style.display = "block";
                    document.getElementById("hs_aftertext").style.display = "none";
                }
				var delta = s;
				...
				if ( days != days_prev ) {
					...
					cd.find( '.hs_days' ).html( days_html + '<div class="hs_days_text"><div class="hs_Seperator"></div><span>' + cd.find( '.hs_days' ).data( 'text' ) + '</span></div>' );
