(function ($) {
    ...
    function bt_video_background() {
        $('.boldSection.video').each(function () {
            ...
            var h = $(this).height();
            if (w / h > 16 / 9) {
                video.css('min-width', '110%');
                video.css('min-height', '110%');
            } else {
                video.css('min-width', '110%');
                video.css('min-height', '110%');
            }
    ...
    $(document).ready(function () {
        ...
        $('.btCountdownHolder').each(function () {
            ...
            var output = function () {
                ...
                //				console.log ("Countdown Finished : " + countdownfinished);
                //                if (countdownfinished){
                //                    console.log ("Switching Content...");
                //                    document.getElementById("hs_player").style.display = "block";
                //                    document.getElementById("hs_counter").style.display = "none";
                //                } else {
                //                    document.getElementById("hs_player").style.display = "none";
                //                    document.getElementById("hs_counter").style.display = "block";
                //                }
                var delta = s;
        ...
        $('.hs_CountdownHolder').each(function () {
            ...
            var output = function () {
                ...
                const eventStatus = document.getElementById("EventStatus").textContent.trim();
                ...
                if (countdownfinished) {
                    ...
                    document.getElementById("hs_counter").style.display = "none";
                    document.getElementById("hs_beforetextcont").style.display = "none";
                    document.getElementById("hs_aftertextcont").style.display = "block";
                } else {
                    document.getElementById("hs_player").style.display = "none";
                    document.getElementById("hs_counter").style.display = "inline-block";
                    document.getElementById("hs_beforetextcont").style.display = "block";
                    document.getElementById("hs_aftertextcont").style.display = "none";
                }
                ...
                for (var i = 0; i <= 1; i++) {
                    countdown('.hs_seconds .n' + i, i, seconds_arr, seconds_arr_prev);
                    countdown('.hs_minutes .n' + i, i, minutes_arr, minutes_arr_prev);
                    countdown('.hs_hours .n' + i, i, hours_arr, hours_arr_prev);
                }
                ...
                if (days != days_prev) {
                    ...
                    cd.find('.hs_days').html(days_html + '<div class="hs_days_text"><div class="Seperator-wrapper"><div class="hs_Seperator"></div></div><span>' + cd.find('.hs_days').data('text') + '</span></div>');
                    //                    Get Colors from page template to refresh any color changes.
                    //                    getColors();
                }

                if (days < 1) {
                    document.getElementsByClassName('hs_days')[0].style.display = "none";
                }
