(function ($) {
    ...
    $(document).ready(function () {
        ...
        // HS Countdown — moved to the child theme (celebration-child/js/hs-countdown.js,
        // enqueued via functions.php) so the fix is in the deploy pipeline and survives
        // parent updates. Intentionally not initialised here to avoid double-binding.
