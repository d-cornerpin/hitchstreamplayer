<?php
/*
Template Name: Player -  Big Modern 
*/
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        #hs_couplename.invert span::before {
    ...
    <style>
        ...
        @media (max-width: 920px) {
            ...
            /*Bring Couple Name Up a bit*/
            .hs_couplenamecont {
                margin: 0 auto 40px auto;
            }

            /*Socials Styling Mobile*/
            .hs_socials {
                padding-top: 35px;
            }
...
<body class="hs_body" id="hs_page_body">
    ...
    <?php if (have_posts()) {
        while (have_posts()):
            ...
            echo '<div class="hs_container" style="background-image: url(\'https://hitchstream.com/wp-content/themes/celebration-child/img/lights_overlay4.jpg\'), url(\'' .
                $CoupleImageUrl .
                '\');"><div class="hs_blur"><div class="hs_width">';
            /* End Write background image div */

            /* This is a hidden div that knows if the event is over or not */
            $IsComplete = get_status();
            echo '<div id="EventStatus" class="hideme">' .
                $IsComplete .
                "</div>";
            ...
            if ($NameImageUrl != "") {
                ...
                $couplenameoutput =
                    '<div class="hs_couplenamecont"><div id="hs_couplename" class="hs_couplename"><span class="firstname" style="' .
                    $Color1 .
                    ';">' .
                    $Couplename1 .
                    " " .
                    $CouplenameSep .
                    " " .
                    '</span><span class="secondname" style="' .
                    $Color2 .
                    ';">' .
                    $Couplename2 .
            ...
            /* Video Player */
            $playeroutput =
                '<div id="hs_player" class="hs_playercontainer" style="position:relative;"><div class="hs_playerbox"> <iframe src="' . $PlayerURL . '" style="border: none; width: 100%; aspect-ratio: 16 / 9;" allow="fullscreen; accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe></div></div>';
            echo $playeroutput;
            ...
            $FormatDateTime =
                $dateObj->format("g:i A") .
                " $abbreviation<br>" .
                $dateObj->format("l, F jS, Y");
            $datetimeoutput =
