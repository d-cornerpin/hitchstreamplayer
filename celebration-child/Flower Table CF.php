<?php
/*
Template Name: Player - Flower Table 
*/
?>
<!DOCTYPE html>
...
<head>
    ...
    <!--    Page variables-->
    <?php
	$resizes = "hs_beforetext,40,hs_aftertext,40,hs_couplename,90,hs_footer,30";
...
?>
    ...
    <style>
        ...
        .hs_body {
            ...
            background-image: url('https://hitchstream.com/wp-content/themes/celebration-child/img/bg_theme002.jpg');
...
*/
    ...
    <style>
        ...
        @media (max-width: 635px) {
            ...
            .hs_body {
                background-image: url('https://hitchstream.com/wp-content/themes/celebration-child/img/bg_theme002_mobile.jpg');
            }
