<?php
/*
Template Name: Player - Event Generic v2
*/
?>
<!DOCTYPE html>
...
<body class="hs_body" id="hs_page_body">
    ...
    <?php if (have_posts()) {
        while (have_posts()):
            ...
            echo "<div class='background-image' style='background-image: url(\"{$BackgroundImageUrl}\"); background-color: {$BackgroundColor};'></div><div class='effect-overlay shimmer'></div><div class='content'>";
...
//            echo $eventtitle;
            ...
            /* Before Text */
            $beforetextoutput = '<div id="hs_beforetextcont" class="hs_beforetextcont"><div id="hs_beforetext" class="hs_beforetext" style="color:' . $Color2 . ';">' . $Beforetext . "</div></div>";
            echo $beforetextoutput;
            /* Before Text */

            /* After Text */
            $aftertextoutput = '<div id="hs_aftertextcont" class="hs_aftertextcont"><div id="hs_aftertext" class="hs_aftertext" style="color:' . $Color2 . ';">' . $Aftertext . "</div></div>";
            ...
            $datetimeoutput = '<div id="hs_footercont" class="hs_footercont"><div id="hs_footer" class="hs_footer"><div class="hs_dateandtime" style="color:' . $Color2 . ';">' . $FormatDateTime . "</div>";
            echo $datetimeoutput;
            ...
            /* Venue */
            if (!empty($Venuename)) {
                $venueoutput = '<div class="hs_venue" style="color:' . $Color2 . ';">' . '<a href = "' . $VenueUrl . '">at ' . $Venuename . '</a></div></div></div>';
                echo $venueoutput;
            }
            ...
            $socialiconsoutput = '<div id="hs_socials" class="hs_socials" style="color:' . $Color2 . ' !important;">';
